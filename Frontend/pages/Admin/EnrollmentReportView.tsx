...
const AdminEnrollmentReportView: FunctionComponent = () => {
        ...
        <div className={styles.studentSearchcoursesInputView}>
            <div className={styles.tab}>
                <div className={styles.left}>
                    ...
                    <div className={styles.button2} onClick={onEnrollmentReportClick}>
                ...
                <div className={styles.rightSide}>
					<div className={styles.coursesCard}>
						<div className={styles.header}>
							<div className={styles.text}>Enrollment Reports</div>
						</div>
...
export default AdminEnrollmentReportView;
