...
const AdminDepartmentReportView: FunctionComponent = () => {
        ...
        <div className={styles.studentSearchcoursesInputView}>
            <div className={styles.tab}>
                <div className={styles.left}>
                    ...
                    <div className={styles.button2} onClick={onDepartmentReportClick}>
                ...
                <div className={styles.rightSide}>
					<div className={styles.coursesCard}>
						<div className={styles.header}>
							<div className={styles.text}>Department Reports</div>
						</div>
...
export default AdminDepartmentReportView;
