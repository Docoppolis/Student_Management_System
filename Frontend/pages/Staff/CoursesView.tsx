          					...
          					<div className={styles.filtersCard}>
            						...
            						<div className={styles.body}>
              							...
              							<div className={styles.coursePrefix}>
                								...
                								<input className={styles.typeCoursePrefixWrapper} type="text" placeholder="e.g., 3" maxLength={1} />
              							</div>
              							<div className={styles.coursePrefix}>
                								<div className={styles.text}>Major(s):</div>
                								<input className={styles.typeCoursePrefixWrapper} type="text" placeholder="e.g., CSE, CS, PHY" />
              							</div>
